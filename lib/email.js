...
function buildICS(ev) {
  ...
  return ['BEGIN:VCALENDAR', 'VERSION:2.0', 'PRODID:-//WCMA//Lead//EN', 'CALSCALE:GREGORIAN', 'METHOD:REQUEST',
    'BEGIN:VEVENT', 'UID:' + ev.uid, 'DTSTAMP:' + icsStamp(start), 'DTSTART:' + icsStamp(start), 'DTEND:' + icsStamp(end),
    'SUMMARY:' + icsEscape(ev.summary), 'DESCRIPTION:' + icsEscape(ev.description || ''), 'TRANSP:TRANSPARENT', 'STATUS:CONFIRMED',
